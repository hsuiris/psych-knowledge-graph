...
export const DETAILS: Record<string, ConceptDetail> = {
  ...
  freud: {
    detail:
      "佛洛伊德在維也納行醫，原本研究神經學，後來在治療歇斯底里症病人的過程中發展出「談話治療」。1900 年他出版《夢的解析》，主張夢是通往潛意識的途徑。\n\n他把人格分成本我、自我與超我三個部分，並認為童年經驗會形塑成年後的性格與困擾。許多具體主張後來受到質疑，但「行為背後有自己沒察覺的動機」這個想法，仍是心理治療的共同出發點。",
  },
  "anna-freud": {
    detail:
      "安娜·佛洛伊德延續父親的理論，但把重心從本我轉到自我，被視為自我心理學的奠基者之一。她在《自我與防衛機制》中整理出壓抑、投射、昇華等防衛機制。\n\n她在倫敦創辦漢普斯特德兒童治療診所（今安娜·佛洛伊德中心），把精神分析應用到兒童身上，重視觀察兒童在日常環境中的發展。",
  },
  rogers: {
    detail:
      "羅吉斯早年從事兒童輔導工作，發現直接告訴當事人該怎麼做的效果有限，於是轉向相信當事人最了解自己的問題。1951 年他出版《當事人中心治療》，1957 年提出促成治療改變的「必要且充分條件」，其中最核心的是同理心、真誠與無條件正向關懷。\n\n他也是最早把晤談錄音拿來研究治療歷程的學者之一，推動了心理治療的實證研究。",
  },
  beck: {
    detail:
      "貝克在賓州大學研究憂鬱症時注意到，病人會反覆冒出對自己、世界與未來的負向想法，他稱為「負向認知三角」（negative cognitive triad）。他據此提出自動化思考、認知扭曲與基模等概念，並編製貝克憂鬱量表，讓憂鬱的嚴重程度可以量化追蹤。\n\n他的女兒 Judith S. Beck 延續他的工作，在費城的 Beck Institute 培訓認知行為治療的治療師。",
  },
  ellis: {
    detail:
      "艾里斯在 1955 年提出理性治療，後來更名為理情行為治療。他用 ABC 模式說明情緒困擾：A 是引發事件，B 是對事件的信念，C 是情緒與行為的後果。\n\n治療的重點是找出「一定要」「絕對不能」這類僵化的信念，並直接加以駁斥。這套做法比貝克的認知治療更早出現，兩者共同奠定了認知行為治療的基礎。",
  },
  perls: {
    detail:
      "Perls 原本受精神分析訓練，後來受完形心理學與存在主義影響。他認為與其分析過去，不如協助當事人覺察此時此地的感受與身體反應。\n\n1960 年代他在加州的 Esalen Institute 帶領工作坊，讓完形治療廣為人知。空椅法就是他常用的技術：請當事人對著空椅子說話，把沒說完的話或未完成事件帶到當下處理。",
  },
  linehan: {
    detail:
      "Linehan 在華盛頓大學發展辯證行為治療。她發現傳統 CBT 一味要求改變，會讓情緒極度敏感的當事人覺得不被理解，因此把「接納」與「改變」放在一起，並引入禪修的正念練習。\n\n1991 年她發表的隨機對照試驗，讓 DBT 成為第一個經實證支持、對邊緣型人格障礙有效的心理治療。2011 年她公開自己年輕時曾因嚴重自傷住院的經歷。",
  },
  hayes: {
    detail:
      "Hayes 在內華達大學任教。他主張痛苦本身是人生的一部分，讓人卡住的是想擺脫痛苦的掙扎。接納與承諾治療透過接納、認知脫鉤與價值澄清培養「心理彈性」，讓人帶著不舒服的感受，仍然朝自己重視的方向行動。\n\n他曾公開談到自己受恐慌症所苦的經驗，並表示這段經驗影響了 ACT 的發展。",
  },
  bowlby: {
    detail:
      "鮑比在二戰後受世界衛生組織委託，研究與父母分離的兒童，觀察到長期分離對孩子情緒發展的傷害。他結合精神分析與動物行為學，在 1969 到 1980 年間出版《依附與失落》三部曲。\n\n他提出「內在運作模式」（internal working model）：早年的依附經驗會變成對自己與他人的預期，影響日後的人際關係。Mary Ainsworth 的實驗研究讓這套理論可以被驗證。",
  },
  ainsworth: {
    detail:
      "Ainsworth 曾在倫敦與鮑比共事，之後分別在烏干達與美國巴爾的摩長期觀察母嬰互動。陌生情境實驗讓幼兒經歷與母親短暫分開、再重逢的過程，觀察重逢時的反應。\n\n這個方法讓依附理論可以被測量與驗證。後來她的學生 Mary Main 補上了第四種「混亂型」依附。",
  },
  pavlov: {
    detail:
      "巴夫洛夫原本研究狗的唾液分泌，注意到狗在還沒吃到食物、只是看到餵食的人時就開始流口水。他進一步讓節拍器聲響等中性刺激與食物配對，證明學習可以用可觀察的刺激與反應來研究。\n\n這項發現成為行為主義的基礎，也是暴露療法等行為治療技術的理論來源。",
  },
  skinner: {
    detail:
      "史金納設計了「史金納箱」，觀察動物按壓槓桿的頻率如何隨獎勵或懲罰改變，並區分正增強、負增強與懲罰等不同後果。他主張心理學應該只研究可觀察的行為。\n\n操作制約後來被應用在行為改變技術、代幣制度與教育上，自閉症類群障礙的早期介入也大量採用這套原理。",
  },
  bandura: {
    detail:
      "班度拉在 1960 年代的波波玩偶實驗中發現，孩子看到大人打玩偶後，自己也會模仿攻擊行為。這說明人可以透過觀察別人學習，不一定要親身得到獎懲。\n\n1977 年他提出自我效能，指一個人對自己能否完成某件事的信心，並指出成功經驗、觀察他人、口頭鼓勵與身心狀態是自我效能的四個來源。他長年在史丹佛大學任教。",
  },
  minuchin: {
    detail:
      "米紐慶在紐約為低收入家庭的青少年工作時，發現單獨治療孩子效果有限，問題往往跟整個家庭的互動方式有關。他後來主持費城兒童輔導診所，發展出結構派家族治療。\n\n結構派治療師會在晤談中直接介入，例如調整家人的座位、請家人當場對話，藉此重新安排家庭中的界限與次系統。代表作是 1974 年出版的 Families and Family Therapy。",
  },
  "michael-white": {
    detail:
      "懷特受到哲學家傅柯與人類學的影響，認為人對自己的理解是由故事構成的，而主流文化常讓人把問題當成自己的本質。他提出「問題外化」：人不等於問題，問題本身才是問題。\n\n1990 年他與 David Epston 出版 Narrative Means to Therapeutic Ends，是敘事治療的奠基之作。",
  },
  "de-shazer": {
    detail:
      "de Shazer 與 Insoo Kim Berg 在美國密爾瓦基的短期家族治療中心，觀看大量晤談錄影，整理出哪些問話真的能帶來改變。他們發現與其追究問題的成因，不如找出問題沒有發生的「例外」時刻，再擴大這些已經有效的做法。\n\n奇蹟問句、例外問句與量尺問句都來自這段研究。",
  },
  "kabat-zinn": {
    detail:
      "卡巴金把正念定義為「刻意地、不帶評價地注意當下」，並把禪修練習整理成不帶宗教色彩的八週課程，最初用來協助慢性疼痛病人。\n\n正念減壓後來成為許多第三波治療的基礎。正念認知治療就是把 MBSR 與認知治療結合，用來預防憂鬱復發。",
  },
  shapiro: {
    detail:
      "Shapiro 在 1987 年散步時注意到，眼球快速來回移動之後，困擾她的念頭似乎沒那麼強烈了。她據此發展出 EMDR，1989 年發表第一篇研究。\n\nEMDR 在回想創傷記憶的同時加入眼動等雙側刺激，協助當事人重新處理創傷經驗。世界衛生組織在 2013 年的指引中，把 EMDR 列為創傷後壓力症的建議治療之一。",
  },
  "william-miller": {
    detail:
      "Miller 研究酗酒治療時發現，治療師的同理程度比採用哪一種治療方法更能預測療效；對抗、說教的方式反而會增加當事人的抗拒。\n\n他在 1983 年發表動機式晤談的初步構想，1991 年與 Stephen Rollnick 合著 Motivational Interviewing 一書，強調引出當事人自己想改變的理由。",
  },
  yalom: {
    detail:
      "亞隆長年在史丹佛大學任教。1970 年他出版 The Theory and Practice of Group Psychotherapy，整理出希望感、普同感、人際學習等團體療效因子，這本書至今仍是團體治療的標準教科書。\n\n他也從存在主義出發，探討死亡、自由、孤獨與無意義四個終極關懷，並把治療經驗寫成《當尼采哭泣》等小說。",
  },
  wechsler: {
    detail:
      "魏克斯勒在紐約貝爾維尤醫院擔任首席心理師時，認為當時的比西量表太偏重語文能力，也不適合評估成人。1939 年他推出魏氏-貝爾維尤智力量表，後來發展成 WAIS 與 WISC。\n\n他把智力定義為「有目的地行動、理性思考並有效應對環境的整體能力」，因此量表同時包含語文與作業兩類分測驗。",
  },
};
